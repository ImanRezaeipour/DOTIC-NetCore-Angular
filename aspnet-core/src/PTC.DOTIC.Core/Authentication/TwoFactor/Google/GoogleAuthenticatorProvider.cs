...
{
    public class GoogleAuthenticatorProvider : DOTICServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("PTC.DOTIC", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
