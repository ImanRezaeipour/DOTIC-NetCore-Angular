...
using PTC.DOTIC.Web.Chat.SignalR;
using PaulMiami.AspNetCore.Mvc.Recaptcha;
using Swashbuckle.AspNetCore.Swagger;
using PTC.DOTIC.Web.IdentityServer;
using PTC.DOTIC.Web.Startup.Swagger;
using PTC.DOTIC.Web.Swagger;
...
namespace PTC.DOTIC.Web.Startup
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "DOTIC API V1");
