...
namespace PTC.DOTIC.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    public abstract class DOTICRepositoryBase<TEntity, TPrimaryKey> : EfCoreRepositoryBase<DOTICDbContext, TEntity, TPrimaryKey>
